...
func (mr *MockIUserManagementUsecaseMockRecorder) EditUser(ctx, input interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "EditUser", reflect.TypeOf((*MockIUserManagementUsecase)(nil).EditUser), ctx, input)
}
